...
urlpatterns = [
    ...
    path('poll-movie-recommendations/', views.poll_movie_recommendations, name='poll_movie_recommendations'),
    path('poll-first-run-recommendations/', views.poll_first_run_recommendations, name='poll_first_run_recommendations'),
    ...
    path('api-config/', views.get_api_config, name='get_api_config'),
]
